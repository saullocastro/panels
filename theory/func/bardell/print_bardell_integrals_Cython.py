...
for i, filepath in enumerate(
    ...
    with open(filepath) as f:
        ...
        if '_12' in filepath:
            ...
            with open('.\\bardell_integrals_Cython\\bardell_%s.pxd' % name, 'w') as g:
        ...
        if '_12' in filepath:
            ...
            with open('.\\bardell_integrals_Cython\\bardell_%s.pyx' % name, 'w') as g:
                g.write(printstr_12)
        else:
            printstr_full += printstr


with open('.\\bardell_integrals_Cython\\bardell_integrals_Cython_full.txt', 'w') as g:
