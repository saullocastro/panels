...
if __name__ == "__main__":
    ...
    if True:
        ...
        if False:
            ...
            dmg_index, del_d, kw_tsl, force_intgn, displ_top_root, displ_bot_root, c_all = test_dcb_damage_prop(no_pan=3, no_terms=[4,4], filename='', k_i=1e4, tau_o=67, no_x_gauss=50, no_y_gauss=25, w_iter_no_pts=None, G1c=0.28)
        ...
        if True:
            ...
            ftn_arg = [(3,[15,8],f'p3_m15_8_ki1e4_tauo67_nx50_ny25_wpts15_G1c{G1c}',1e4,67,50,25,15,G1c) for G1c in [0.56,0.84,1.0,1.05,1.12,1.25,1.5]]

            # create the process pool
            with Pool() as pool: # using 20 cpus on the cluster
                pool.starmap(test_dcb_damage_prop, ftn_arg)
