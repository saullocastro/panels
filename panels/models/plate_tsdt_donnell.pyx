            ...
            for k in range(m):
                ...
                for j in range(n):
                    for l in range(n):
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+2
                        k0v[c] += -2*E11*b*c1*fAuxifBwxixi*gAugBw/(a*a) - 2*E12*c1*fAuxifBw*gAugBwetaeta/b - 2*E16*c1*fAufBwxixi*gAuetagBw/a - 4*E16*c1*fAuxifBwxi*gAugBweta/a - 2*E26*a*c1*fAufBw*gAuetagBwetaeta/(b*b) - 4*E66*c1*fAufBwxi*gAuetagBweta/b
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+3
                        ...
                        k0r[c] = row+1
                        k0c[c] = col+2
                        k0v[c] += -2*E12*c1*fAvfBwxixi*gAvetagBw/a - 2*E16*b*c1*fAvxifBwxixi*gAvgBw/(a*a) - 2*E22*a*c1*fAvfBw*gAvetagBwetaeta/(b*b) - 4*E26*c1*fAvfBwxi*gAvetagBweta/b - 2*E26*c1*fAvxifBw*gAvgBwetaeta/b - 4*E66*c1*fAvxifBwxi*gAvgBweta/a
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+3
                        ...
                        k0r[c] = row+3
                        k0c[c] = col+2
                        k0v[c] += 0.5*A45*a*fAphixfBw*gAphixgBweta + 0.5*A55*b*fAphixfBwxi*gAphixgBw - 3*D45*a*c1*fAphixfBw*gAphixgBweta - 3*D55*b*c1*fAphixfBwxi*gAphixgBw - 2*F11*b*c1*fAphixxifBwxixi*gAphixgBw/(a*a) - 2*F12*c1*fAphixxifBw*gAphixgBwetaeta/b - 2*F16*c1*fAphixfBwxixi*gAphixetagBw/a - 4*F16*c1*fAphixxifBwxi*gAphixgBweta/a - 2*F26*a*c1*fAphixfBw*gAphixetagBwetaeta/(b*b) + 4.5*F45*a*(c1*c1)*fAphixfBw*gAphixgBweta + 4.5*F55*b*(c1*c1)*fAphixfBwxi*gAphixgBw - 4*F66*c1*fAphixfBwxi*gAphixetagBweta/b + 2*H11*b*(c1*c1)*fAphixxifBwxixi*gAphixgBw/(a*a) + 2*H12*(c1*c1)*fAphixxifBw*gAphixgBwetaeta/b + 2*H16*(c1*c1)*fAphixfBwxixi*gAphixetagBw/a + 4*H16*(c1*c1)*fAphixxifBwxi*gAphixgBweta/a + 2*H26*a*(c1*c1)*fAphixfBw*gAphixetagBwetaeta/(b*b) + 4*H66*(c1*c1)*fAphixfBwxi*gAphixetagBweta/b
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+3
