            ...
            for k in range(m):
                ...
                for j in range(n):
                    for l in range(n):
                        ...
                        k0r[c] = row+0
                        k0c[c] = col+2
                        k0v[c] += 0.5*A12*b*fAuxifBw*gAugBw/r + 0.5*A26*a*fAufBw*gAuetagBw/r - 0.25*B26*a*fAufBw*gAuetagBw/(r*r) - 2*E11*b*c1*fAuxifBwxixi*gAugBw/(a*a) - 2*E12*c1*fAuxifBw*gAugBwetaeta/b - 2*E16*c1*fAufBwxixi*gAuetagBw/a - 4*E16*c1*fAuxifBwxi*gAugBweta/a - 2*E26*a*c1*fAufBw*gAuetagBwetaeta/(b*b) - 4*E66*c1*fAufBwxi*gAuetagBweta/b + F16*c1*fAufBwxixi*gAuetagBw/(a*r) + F26*a*c1*fAufBw*gAuetagBwetaeta/((b*b)*r) + 2*F66*c1*fAufBwxi*gAuetagBweta/(b*r)
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+3
                        k0v[c] += B11*b*fAuxifBphixxi*gAugBphix/a + B16*fAufBphixxi*gAuetagBphix + B16*fAuxifBphix*gAugBphixeta + B66*a*fAufBphix*gAuetagBphixeta/b - 0.5*D16*fAufBphixxi*gAuetagBphix/r - 0.5*D66*a*fAufBphix*gAuetagBphixeta/(b*r) - E11*b*c1*fAuxifBphixxi*gAugBphix/a - E16*c1*fAufBphixxi*gAuetagBphix - E16*c1*fAuxifBphix*gAugBphixeta - E66*a*c1*fAufBphix*gAuetagBphixeta/b + 0.5*F16*c1*fAufBphixxi*gAuetagBphix/r + 0.5*F66*a*c1*fAufBphix*gAuetagBphixeta/(b*r)
                        c += 1
                        k0r[c] = row+0
                        k0c[c] = col+4
                        k0v[c] += B12*fAuxifBphiy*gAugBphiyeta + B16*b*fAuxifBphiyxi*gAugBphiy/a + B26*a*fAufBphiy*gAuetagBphiyeta/b + B66*fAufBphiyxi*gAuetagBphiy - 0.5*D26*a*fAufBphiy*gAuetagBphiyeta/(b*r) - 0.5*D66*fAufBphiyxi*gAuetagBphiy/r - E12*c1*fAuxifBphiy*gAugBphiyeta - E16*b*c1*fAuxifBphiyxi*gAugBphiy/a - E26*a*c1*fAufBphiy*gAuetagBphiyeta/b - E66*c1*fAufBphiyxi*gAuetagBphiy + 0.5*F26*a*c1*fAufBphiy*gAuetagBphiyeta/(b*r) + 0.5*F66*c1*fAufBphiyxi*gAuetagBphiy/r
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col+0
                        ...
                        k0r[c] = row+1
                        k0c[c] = col+2
                        k0v[c] += 0.5*A22*a*fAvfBw*gAvetagBw/r + 0.5*A26*b*fAvxifBw*gAvgBw/r + 0.5*B22*a*fAvfBw*gAvetagBw/(r*r) + 0.75*B26*b*fAvxifBw*gAvgBw/(r*r) - 2*E12*c1*fAvfBwxixi*gAvetagBw/a - 2*E16*b*c1*fAvxifBwxixi*gAvgBw/(a*a) - 2*E22*a*c1*fAvfBw*gAvetagBwetaeta/(b*b) - 4*E26*c1*fAvfBwxi*gAvetagBweta/b - 2*E26*c1*fAvxifBw*gAvgBwetaeta/b - 4*E66*c1*fAvxifBwxi*gAvgBweta/a - 2*F12*c1*fAvfBwxixi*gAvetagBw/(a*r) - 3*F16*b*c1*fAvxifBwxixi*gAvgBw/((a*a)*r) - 2*F22*a*c1*fAvfBw*gAvetagBwetaeta/((b*b)*r) - 4*F26*c1*fAvfBwxi*gAvetagBweta/(b*r) - 3*F26*c1*fAvxifBw*gAvgBwetaeta/(b*r) - 6*F66*c1*fAvxifBwxi*gAvgBweta/(a*r)
                        c += 1
                        k0r[c] = row+1
                        k0c[c] = col
agBv/a - 2*F12*c1*fAwxixifBv*gAwgBveta/(a*r) - 3*F16*b*c1*fAwxixifBvxi*gAwgBv/((a*a)*r) - 2*F22*a*c1*fAwfBv*gAwetaetagBveta/((b*b)*r) - 3*F26*c1*fAwfBvxi*gAwetaetagBv/(b*r) - 4*F26*c1*fAwxifBv*gAwetagBveta/(b*r) - 6*F66*c1*fAwxifBvxi*gAwetagBv/(a*r)
                        c += 1
                        k0r[c] = row+2
                        k0c[c] = col+2
                        ...
                        k0r[c] = row+3
                        k0c[c] = col+0
                        k0v[c] += B11*b*fAphixxifBuxi*gAphixgBu/a + B16*fAphixfBuxi*gAphixetagBu + B16*fAphixxifBu*gAphixgBueta + B66*a*fAphixfBu*gAphixetagBueta/b - 0.5*D16*fAphixxifBu*gAphixgBueta/r - 0.5*D66*a*fAphixfBu*gAphixetagBueta/(b*r) - E11*b*c1*fAphixxifBuxi*gAphixgBu/a - E16*c1*fAphixfBuxi*gAphixetagBu - E16*c1*fAphixxifBu*gAphixgBueta - E66*a*c1*fAphixfBu*gAphixetagBueta/b + 0.5*F16*c1*fAphixxifBu*gAphixgBueta/r + 0.5*F66*a*c1*fAphixfBu*gAphixetagBueta/(b*r)
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+1
                        k0v[c] += B12*fAphixxifBv*gAphixgBveta + B16*b*fAphixxifBvxi*gAphixgBv/a + B26*a*fAphixfBv*gAphixetagBveta/b + B66*fAphixfBvxi*gAphixetagBv + D12*fAphixxifBv*gAphixgBveta/r + 1.5*D16*b*fAphixxifBvxi*gAphixgBv/(a*r) + D26*a*fAphixfBv*gAphixetagBveta/(b*r) + 1.5*D66*fAphixfBvxi*gAphixetagBv/r - E12*c1*fAphixxifBv*gAphixgBveta - E16*b*c1*fAphixxifBvxi*gAphixgBv/a - E26*a*c1*fAphixfBv*gAphixetagBveta/b - E66*c1*fAphixfBvxi*gAphixetagBv - F12*c1*fAphixxifBv*gAphixgBveta/r - 1.5*F16*b*c1*fAphixxifBvxi*gAphixgBv/(a*r) - F26*a*c1*fAphixfBv*gAphixetagBveta/(b*r) - 1.5*F66*c1*fAphixfBvxi*gAphixetagBv/r
                        c += 1
                        k0r[c] = row+3
                        k0c[c] = col+2
                        ...
                        k0r[c] = row+4
                        k0c[c] = col+0
                        k0v[c] += B12*fAphiyfBuxi*gAphiyetagBu + B16*b*fAphiyxifBuxi*gAphiygBu/a + B26*a*fAphiyfBu*gAphiyetagBueta/b + B66*fAphiyxifBu*gAphiygBueta - 0.5*D26*a*fAphiyfBu*gAphiyetagBueta/(b*r) - 0.5*D66*fAphiyxifBu*gAphiygBueta/r - E12*c1*fAphiyfBuxi*gAphiyetagBu - E16*b*c1*fAphiyxifBuxi*gAphiygBu/a - E26*a*c1*fAphiyfBu*gAphiyetagBueta/b - E66*c1*fAphiyxifBu*gAphiygBueta + 0.5*F26*a*c1*fAphiyfBu*gAphiyetagBueta/(b*r) + 0.5*F66*c1*fAphiyxifBu*gAphiygBueta/r
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+1
                        k0v[c] += B22*a*fAphiyfBv*gAphiyetagBveta/b + B26*fAphiyfBvxi*gAphiyetagBv + B26*fAphiyxifBv*gAphiygBveta + B66*b*fAphiyxifBvxi*gAphiygBv/a + D22*a*fAphiyfBv*gAphiyetagBveta/(b*r) + 1.5*D26*fAphiyfBvxi*gAphiyetagBv/r + D26*fAphiyxifBv*gAphiygBveta/r + 1.5*D66*b*fAphiyxifBvxi*gAphiygBv/(a*r) - E22*a*c1*fAphiyfBv*gAphiyetagBveta/b - E26*c1*fAphiyfBvxi*gAphiyetagBv - E26*c1*fAphiyxifBv*gAphiygBveta - E66*b*c1*fAphiyxifBvxi*gAphiygBv/a - F22*a*c1*fAphiyfBv*gAphiyetagBveta/(b*r) - 1.5*F26*c1*fAphiyfBvxi*gAphiyetagBv/r - F26*c1*fAphiyxifBv*gAphiygBveta/r - 1.5*F66*b*c1*fAphiyxifBvxi*gAphiygBv/(a*r)
                        c += 1
                        k0r[c] = row+4
                        k0c[c] = col+2
            ...
            for k in range(m):
                ...
                for j in range(n):
                    for l in range(n):
                        ...
                        kMr[c] = row+1
                        kMc[c] = col+2
                        kMv[c] += -0.5*a*c1*(d*d*d*d)*fAvfBw*gAvgBweta*h*rho/r + 0.5*a*c1*(d*d*d)*fAvfBw*gAvgBweta*h*rho - 0.25*a*c1*(d*d)*fAvfBw*gAvgBweta*(h*h*h)*rho/r + 0.125*a*c1*d*fAvfBw*gAvgBweta*(h*h*h)*rho - 0.00625*a*c1*fAvfBw*gAvgBweta*(h*h*h*h*h)*rho/r
                        c += 1
                        kMr[c] = row+1
                        kMc[c] = col+4
                        kMv[c] += -0.25*a*b*c1*(d*d*d*d)*fAvfBphiy*gAvgBphiy*h*rho/r + 0.25*a*b*c1*(d*d*d)*fAvfBphiy*gAvgBphiy*h*rho - 0.125*a*b*c1*(d*d)*fAvfBphiy*gAvgBphiy*(h*h*h)*rho/r + 0.0625*a*b*c1*d*fAvfBphiy*gAvgBphiy*(h*h*h)*rho - 0.003125*a*b*c1*fAvfBphiy*gAvgBphiy*(h*h*h*h*h)*rho/r + 0.25*a*b*(d*d)*fAvfBphiy*gAvgBphiy*h*rho/r - 0.25*a*b*d*fAvfBphiy*gAvgBphiy*h*rho + 0.020833333333333332*a*b*fAvfBphiy*gAvgBphiy*(h*h*h)*rho/r
                        c += 1
                        kMr[c] = row+2
                        kMc[c] = col+0
                        ...
                        kMr[c] = row+2
                        kMc[c] = col+1
                        kMv[c] += -0.5*a*c1*(d*d*d*d)*fAwfBv*gAwetagBv*h*rho/r + 0.5*a*c1*(d*d*d)*fAwfBv*gAwetagBv*h*rho - 0.25*a*c1*(d*d)*fAwfBv*gAwetagBv*(h*h*h)*rho/r + 0.125*a*c1*d*fAwfBv*gAwetagBv*(h*h*h)*rho - 0.00625*a*c1*fAwfBv*gAwetagBv*(h*h*h*h*h)*rho/r
                        c += 1
                        kMr[c] = row+2
                        kMc[c] = col+2
                        ...
                        kMr[c] = row+4
                        kMc[c] = col+1
                        kMv[c] += -0.25*a*b*c1*(d*d*d*d)*fAphiyfBv*gAphiygBv*h*rho/r + 0.25*a*b*c1*(d*d*d)*fAphiyfBv*gAphiygBv*h*rho - 0.125*a*b*c1*(d*d)*fAphiyfBv*gAphiygBv*(h*h*h)*rho/r + 0.0625*a*b*c1*d*fAphiyfBv*gAphiygBv*(h*h*h)*rho - 0.003125*a*b*c1*fAphiyfBv*gAphiygBv*(h*h*h*h*h)*rho/r + 0.25*a*b*(d*d)*fAphiyfBv*gAphiygBv*h*rho/r - 0.25*a*b*d*fAphiyfBv*gAphiygBv*h*rho + 0.020833333333333332*a*b*fAphiyfBv*gAphiygBv*(h*h*h)*rho/r
                        c += 1
                        kMr[c] = row+4
                        kMc[c] = col+2
