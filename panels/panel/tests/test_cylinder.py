...
from panels.panel import cylinder_compression_lb_Nxx_cte, cylinder_compression_lb_Nxx_from_static
...
if __name__ == '__main__':
    #test_cylinder_compression_lb_Nxx_cte()
    test_cylinder_compression_lb_Nxx_from_static()
